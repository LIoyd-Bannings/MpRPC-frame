...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ".fixbug.LoginResponse\032\025.fixbug.LoginResp"
  "onse\022N\n\016GetFriendLists\022\035.fixbug.GetFrien"
  "dListsRequest\032\035.fixbug.GetFriendListResp"
...
void UserServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      Login(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::LoginResponse*>(
                 request),
