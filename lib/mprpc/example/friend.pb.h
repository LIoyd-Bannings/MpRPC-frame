...
class GetFriendListResponce;
class GetFriendListResponceDefaultTypeInternal;
extern GetFriendListResponceDefaultTypeInternal _GetFriendListResponce_default_instance_;
class ResultCode;
...
template<> ::fixbug::GetFriendListResponce* Arena::CreateMaybeMessage<::fixbug::GetFriendListResponce>(Arena*);
...
class GetFriendListResponce :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListResponce) */ {
 public:
  GetFriendListResponce();
  virtual ~GetFriendListResponce();

  GetFriendListResponce(const GetFriendListResponce& from);
  GetFriendListResponce(GetFriendListResponce&& from) noexcept
    : GetFriendListResponce() {
    *this = ::std::move(from);
  }

  inline GetFriendListResponce& operator=(const GetFriendListResponce& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListResponce& operator=(GetFriendListResponce&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendListResponce& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendListResponce* internal_default_instance() {
    return reinterpret_cast<const GetFriendListResponce*>(
               &_GetFriendListResponce_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(GetFriendListResponce& a, GetFriendListResponce& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListResponce* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriendListResponce* New() const final {
    return CreateMaybeMessage<GetFriendListResponce>(nullptr);
  }

  GetFriendListResponce* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendListResponce>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendListResponce& from);
  void MergeFrom(const GetFriendListResponce& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListResponce* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListResponce";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListResponce)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListResponce::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendListResponce::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListResponce::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListResponce::_internal_result() const {
...
inline const ::fixbug::ResultCode& GetFriendListResponce::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponce.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GetFriendListResponce::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListResponce.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListResponce::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListResponce::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponce.result)
  return _internal_mutable_result();
}
inline void GetFriendListResponce::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListResponce.result)
}

// repeated bytes friends = 2;
inline int GetFriendListResponce::_internal_friends_size() const {
  return friends_.size();
}
inline int GetFriendListResponce::friends_size() const {
  return _internal_friends_size();
}
inline void GetFriendListResponce::clear_friends() {
  friends_.Clear();
}
inline std::string* GetFriendListResponce::add_friends() {
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFriendListResponce.friends)
  return _internal_add_friends();
}
inline const std::string& GetFriendListResponce::_internal_friends(int index) const {
  return friends_.Get(index);
}
inline const std::string& GetFriendListResponce::friends(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponce.friends)
  return _internal_friends(index);
}
inline std::string* GetFriendListResponce::mutable_friends(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponce.friends)
  return friends_.Mutable(index);
}
inline void GetFriendListResponce::set_friends(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListResponce.friends)
  friends_.Mutable(index)->assign(value);
}
inline void GetFriendListResponce::set_friends(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListResponce.friends)
  friends_.Mutable(index)->assign(std::move(value));
}
inline void GetFriendListResponce::set_friends(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friends_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendListResponce.friends)
}
inline void GetFriendListResponce::set_friends(int index, const void* value, size_t size) {
  friends_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendListResponce.friends)
}
inline std::string* GetFriendListResponce::_internal_add_friends() {
  return friends_.Add();
}
inline void GetFriendListResponce::add_friends(const std::string& value) {
  friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponce.friends)
}
inline void GetFriendListResponce::add_friends(std::string&& value) {
  friends_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponce.friends)
}
inline void GetFriendListResponce::add_friends(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFriendListResponce.friends)
}
inline void GetFriendListResponce::add_friends(const void* value, size_t size) {
  friends_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFriendListResponce.friends)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetFriendListResponce::friends() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListResponce.friends)
  return friends_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetFriendListResponce::mutable_friends() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListResponce.friends)
  return &friends_;
}
