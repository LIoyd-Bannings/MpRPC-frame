...
class GetFriendListResponceDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendListResponce> _instance;
...
static void InitDefaultsscc_info_GetFriendListResponce_friend_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendListResponce_default_instance_;
    new (ptr) ::fixbug::GetFriendListResponce();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendListResponce::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetFriendListResponce_friend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_GetFriendListResponce_friend_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListResponce, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListResponce, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListResponce, friends_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::fixbug::ResultCode)},
  { 7, -1, sizeof(::fixbug::GetFriendListRequest)},
  { 13, -1, sizeof(::fixbug::GetFriendListResponce)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendListResponce_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_friend_2eproto_sccs[3] = {
  ...
  &scc_info_GetFriendListResponce_friend_2eproto.base,
  &scc_info_ResultCode_friend_2eproto.base,
};
...
void GetFriendListResponce::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListResponce_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListResponce::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListResponce* msg);
};

const ::fixbug::ResultCode&
GetFriendListResponce::_Internal::result(const GetFriendListResponce* msg) {
  return *msg->result_;
}
GetFriendListResponce::GetFriendListResponce()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFriendListResponce)
}
GetFriendListResponce::GetFriendListResponce(const GetFriendListResponce& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListResponce)
}

void GetFriendListResponce::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListResponce_friend_2eproto.base);
  result_ = nullptr;
}

GetFriendListResponce::~GetFriendListResponce() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListResponce)
  SharedDtor();
}

void GetFriendListResponce::SharedDtor() {
  if (this != internal_default_instance()) delete result_;
}

void GetFriendListResponce::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendListResponce& GetFriendListResponce::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListResponce_friend_2eproto.base);
  return *internal_default_instance();
}


void GetFriendListResponce::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListResponce)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListResponce::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListResponce::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListResponce)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListResponce)
  return target;
}

size_t GetFriendListResponce::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListResponce)
  size_t total_size = 0;
...
void GetFriendListResponce::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendListResponce)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListResponce* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListResponce>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendListResponce)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendListResponce)
    MergeFrom(*source);
  }
}

void GetFriendListResponce::MergeFrom(const GetFriendListResponce& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListResponce)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListResponce::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendListResponce)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendListResponce::CopyFrom(const GetFriendListResponce& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListResponce)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListResponce::IsInitialized() const {
  return true;
}

void GetFriendListResponce::InternalSwap(GetFriendListResponce* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListResponce::GetMetadata() const {
  return GetMetadataStatic();
}
    ...
    case 0:
      GetFriendList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListResponce*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fixbug::GetFriendListResponce::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListResponce* Arena::CreateMaybeMessage< ::fixbug::GetFriendListResponce >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFriendListResponce >(arena);
}
